...
class MemberGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Member entity")
        ...
        .repeat(2) {
            ...
            .post("/api/members")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "member_login":"SAMPLE_TEXT", "member_email":"SAMPLE_TEXT", "join_date":"2020-01-01T00:00:00.000Z", "memeber_type":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
