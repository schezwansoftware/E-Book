...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/vsGoogleAutocomplete/dist/vs-google-autocomplete.js',
            'src/main/webapp/bower_components/vsGoogleAutocomplete/dist/vs-autocomplete-validator.js',
